...
<body>
	...
	<table cellSpacing="1" cellPadding="0" width="100%" align="center"
		...
		<TBODY>
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3"><strong>Lists of The First Category</strong>
				</TD>
			</tr>
			<tr>
				...
				<td class="ta_01" align="center" bgColor="#f5fafe">
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<tr
							...
							<td align="center" width="17%">Names of First Category</td>
						...
						<tr align="center">
							<td colspan="7"><c:out value="${ page}" />/<c:out value="${count}" />
							 <c:if test="${page != 1 }">
									<a href="listCategory/1">First</a>|
								<a href="${ pageContext.request.contextPath }/listCategory/<c:out value="${page - 1 }"/>">Previous</a>|
							</c:if>
							 <c:if test="${page != count }">
									<a href="${ pageContext.request.contextPath }/listCategory/<c:out value="${page + 1 }"/>">Next</a>|
									<a href="${ pageContext.request.contextPath }/listCategory/<c:out value="${count }"/>">Last</a>|
							</c:if>
							</td>
						</tr>
					</table>
